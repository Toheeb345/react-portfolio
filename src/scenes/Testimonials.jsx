                 ...
                 visible: { opacity: 1, x: 0}
                    ...
                    <p className=" font-playfair font-semibold text-4xl mb-5 text-red">
                       TESTIMONIALS
                        ...
                        <p className="mt-10">
                            Alot of people got good things to say about me, Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iste, asperiores.
                        </p>
            </motion.div>
                ...
                <div className="md:flex md:justify-between gap-8">
                    <motion.div
                     ...
                     visible: { opacity: 1, scale: 1 }
                        ...
                        <p className="text-center text-xl">
                            ipsum dolor sit amet consectetur adipisicing elit. Aperiam, esse?
                        </p>
                    </motion.div>
                    ...
                    <motion.div
                     ...
                     visible: { opacity: 1, scale: 1 }
                        ...
                        <p className="font-playfair text-6xl">“</p>
                        <p className="text-center text-xl">
                        Voluptatem Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo officiis  blanditiis magnam.
                        </p>
                    </motion.div>
                    ...
                    <motion.div
                     ...
                     visible: { opacity: 1, scale: 1 }
                        ...
                        <p className="font-playfair text-6xl">“</p>
                        <p className="text-center text-xl">
                        Ratione Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe voluptatum vero blanditiis hic, voluptate.
                        </p>
                    </motion.div>
                </div>
        </section>
